...
describe("Submit Form Test", () => {
    it("should Fill up form and click Submit Button", () => {
       ...
       cy.get('#lastName').type('Mulleady');
        cy.get('#email').type('andrewmulleady@live.ie');
        cy.get('#phoneNo').type(0871174165);
        cy.get('#companyName').type('Company Name');
        cy.get('#address').type('Truskey West, Barna, Galway');
        ...
        cy.get('#description').type('Hey, I am interested in getting a website made for my sports shop.');
